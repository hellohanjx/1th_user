...
#define IIC_SCL(x)   ((x) ? (GPIOB->BSRR = GPIO_Pin_8):(GPIOB->BSRR |= (GPIO_Pin_8<<16))) //GPIO_PIN_8
#define IIC_SDA(x)   ((x) ? (GPIOB->BSRR = GPIO_Pin_9):(GPIOB->BSRR |= (GPIO_Pin_9<<16))) //GPIO_PIN_9

#define IIC_SDA_STATE	   (GPIOB->IDR & GPIO_Pin_9)                            //0000 0000 1000 0000
