...
#if SCREEN == SCREENRA8875 || SCREEN == V_SCREENRA8875
...
{			
	...
	OSTimeDlyHMSM(0,0,0,2);		//89h 与 88h 被设定后需要等待[锁屏时间](为保证 PLL 稳定) < 100us
